...
class PhysicsSim():
    ...
    def reset(self):
        self.time = 0.0
        # As suggested by students on Udacity forum, it'd make sense to instantiate copies for init arrays; 
        # so we can still reset to deafult values after mutation:
        # https://discussions.udacity.com/t/the-sudden-attack-of-the-nans-project-v2/642588/4
    ...
    def next_timestep(self, rotor_speeds):
        ...
        # As suggested by students on Udacity forum, the acceleration calculations were wrong
        # https://discussions.udacity.com/t/no-progress-on-quadcopter-hover-task-or-mountain-car/665833/4
